...
class BenchFpu_vfnms_f32 : public EntoBench::EntoProblem<BenchFpu_vfnms_f32>
{
public:
  ...
  void prepare_impl()
  {
    entry_[0] = 0x3f000000u;  // 0.5f
    entry_[1] = 0x3f800000u;  // 1.0f
    entry_[2] = 0x40000000u;  // 2.0f
    exit_[0] = 0;
    exit_[1] = 0;
...
int main()
{
  ...
  BenchFpu_vfnms_f32 problem;
  ENTO_BENCH_HARNESS_TYPE(decltype(problem));
  BenchHarness harness(problem, "bench_fpu_vfnms_f32");
  harness.run();
