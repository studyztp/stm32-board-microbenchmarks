...
class BenchFpu_vfms_f32 : public EntoBench::EntoProblem<BenchFpu_vfms_f32>
{
public:
...
int main()
{
  ...
  BenchFpu_vfms_f32 problem;
  ENTO_BENCH_HARNESS_TYPE(decltype(problem));
  BenchHarness harness(problem, "bench_fpu_vfms_f32");
  harness.run();
