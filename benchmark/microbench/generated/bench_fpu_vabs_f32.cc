...
class BenchFpu_vabs_f32 : public EntoBench::EntoProblem<BenchFpu_vabs_f32>
{
public:
...
int main()
{
  ...
  BenchFpu_vabs_f32 problem;
  ENTO_BENCH_HARNESS_TYPE(decltype(problem));
  BenchHarness harness(problem, "bench_fpu_vabs_f32");
  harness.run();
