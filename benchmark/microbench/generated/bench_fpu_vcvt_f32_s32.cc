...
class BenchFpu_vcvt_f32_s32 : public EntoBench::EntoProblem<BenchFpu_vcvt_f32_s32>
{
public:
...
int main()
{
  ...
  BenchFpu_vcvt_f32_s32 problem;
  ENTO_BENCH_HARNESS_TYPE(decltype(problem));
  BenchHarness harness(problem, "bench_fpu_vcvt_f32_s32");
  harness.run();
